...
*get_monomer_mfes = *RNAc::get_monomer_mfes;
*pf_fold = *RNAc::pf_fold;
*pf_fold_pb = *RNAc::pf_fold_pb;
...
*get_intput_line = *RNAc::get_intput_line;
...
*PS_dot_plot_list_epsilon = *RNAc::PS_dot_plot_list_epsilon;
...
*VRNA_INPUT_STRUCTURE = *RNAc::VRNA_INPUT_STRUCTURE;
*VRNA_INPUT_NOPRINT_COMMENTS = *RNAc::VRNA_INPUT_NOPRINT_COMMENTS;
*VRNA_INPUT_NOSKIP_COMMENTS = *RNAc::VRNA_INPUT_NOSKIP_COMMENTS;
*VRNA_INPUT_NOELIM_WS_SUFFIX = *RNAc::VRNA_INPUT_NOELIM_WS_SUFFIX;
