...
#define SWIGTYPE_p_bondT swig_types[4]
...
#define SWIGTYPE_p_p_p_short swig_types[22]
#define SWIGTYPE_p_p_p_unsigned_short swig_types[23]
#define SWIGTYPE_p_p_plist swig_types[24]
#define SWIGTYPE_p_p_short swig_types[25]
#define SWIGTYPE_p_p_void swig_types[26]
#define SWIGTYPE_p_paramT swig_types[27]
#define SWIGTYPE_p_path_t swig_types[28]
#define SWIGTYPE_p_plist swig_types[29]
#define SWIGTYPE_p_short swig_types[30]
#define SWIGTYPE_p_swString swig_types[31]
...
XS(_wrap_get_monomer_mfes) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: get_monomer_mfes();");
    }
    result = (float *)get_monomer_mfes();
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_float, 0 | 0); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
...
XS(_wrap_pf_fold_pb) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: pf_fold_pb(sequence,structure);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "pf_fold_pb" "', argument " "1"" of type '" "char const *""'");
    }
    arg1 = (char *)(buf1);
    res2 = SWIG_AsCharPtrAndSize(ST(1), &buf2, NULL, &alloc2);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "pf_fold_pb" "', argument " "2"" of type '" "char *""'");
    }
    arg2 = (char *)(buf2);
    result = (float)pf_fold_pb((char const *)arg1,arg2);
    ST(argvi) = SWIG_From_float  SWIG_PERL_CALL_ARGS_1((float)(result)); argvi++ ;
    if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
    if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
    XSRETURN(argvi);
...
XS(_wrap_bppm_symbol) {
  {
    ...
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_float, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "bppm_symbol" "', argument " "1"" of type '" "float *""'"); 
    }
    arg1 = (float *)(argp1);
...
XS(_wrap_get_centroid_struct_pr) {
  {
    ...
    if ((items < 3) || (items > 3)) {
      SWIG_croak("Usage: get_centroid_struct_pr(length,dist,pl);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_assign_plist_from_pr) {
  {
    ...
    if ((items < 4) || (items > 4)) {
      SWIG_croak("Usage: assign_plist_from_pr(pl,probs,length,cut_off);");
    }
...
XS(_wrap_circalifold) {
  {
    ...
    arg2 = (char *)(buf2);
    result = (double)circalifold((char const **)arg1,arg2);
    ST(argvi) = SWIG_From_double  SWIG_PERL_CALL_ARGS_1((double)(result)); argvi++ ;
    {
      free(arg1);
    }
...
XS(_wrap_aliLfold) {
  {
    ...
    arg3 = (int)(val3);
    result = (float)aliLfold(arg1,arg2,arg3);
    ST(argvi) = SWIG_From_float  SWIG_PERL_CALL_ARGS_1((float)(result)); argvi++ ;
    {
      free(arg1);
    }
...
XS(_wrap_energy_of_alistruct) {
  {
    ...
    arg4 = (float *)(argp4);
    energy_of_alistruct((char const **)arg1,(char const *)arg2,arg3,arg4);
...
XS(_wrap_get_intput_line) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: get_intput_line(string,options);");
    }
    {
      AV *tempav;
      I32 len;
    ...
    ecode2 = SWIG_AsVal_unsigned_SS_int SWIG_PERL_CALL_ARGS_2(ST(1), &val2);
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "get_intput_line" "', argument " "2"" of type '" "unsigned int""'");
    } 
    arg2 = (unsigned int)(val2);
    result = (unsigned int)get_intput_line(arg1,arg2);
...
XS(_wrap_str_RNA2RNA) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: str_RNA2RNA(sequence);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "str_RNA2RNA" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    str_RNA2RNA(arg1);
...
XS(_wrap_PS_dot_plot_list_epsilon) {
  {
    char *arg1 = (char *) 0 ;
    char *arg2 = (char *) 0 ;
    struct plist *arg3 = (struct plist *) 0 ;
    ...
    if ((items < 6) || (items > 6)) {
      SWIG_croak("Usage: PS_dot_plot_list_epsilon(string,wastlfile,pl,mf,epsilon,comment);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "PS_dot_plot_list_epsilon" "', argument " "1"" of type '" "char *""'");
    }
    arg1 = (char *)(buf1);
    res2 = SWIG_AsCharPtrAndSize(ST(1), &buf2, NULL, &alloc2);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "PS_dot_plot_list_epsilon" "', argument " "2"" of type '" "char *""'");
    }
    arg2 = (char *)(buf2);
    res3 = SWIG_ConvertPtr(ST(2), &argp3,SWIGTYPE_p_plist, 0 |  0 );
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "PS_dot_plot_list_epsilon" "', argument " "3"" of type '" "struct plist *""'"); 
    }
    arg3 = (struct plist *)(argp3);
    res4 = SWIG_ConvertPtr(ST(3), &argp4,SWIGTYPE_p_plist, 0 |  0 );
    if (!SWIG_IsOK(res4)) {
      SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "PS_dot_plot_list_epsilon" "', argument " "4"" of type '" "struct plist *""'"); 
    }
    arg4 = (struct plist *)(argp4);
    res5 = SWIG_ConvertPtr(ST(4), &argp5,SWIGTYPE_p_double, 0 |  0 );
    if (!SWIG_IsOK(res5)) {
      SWIG_exception_fail(SWIG_ArgError(res5), "in method '" "PS_dot_plot_list_epsilon" "', argument " "5"" of type '" "double *""'"); 
    }
    arg5 = (double *)(argp5);
    res6 = SWIG_AsCharPtrAndSize(ST(5), &buf6, NULL, &alloc6);
    if (!SWIG_IsOK(res6)) {
      SWIG_exception_fail(SWIG_ArgError(res6), "in method '" "PS_dot_plot_list_epsilon" "', argument " "6"" of type '" "char *""'");
    }
    arg6 = (char *)(buf6);
    result = (int)PS_dot_plot_list_epsilon(arg1,arg2,arg3,arg4,arg5,arg6);
    ST(argvi) = SWIG_From_int  SWIG_PERL_CALL_ARGS_1((int)(result)); argvi++ ;
    if (alloc1 == SWIG_NEWOBJ) free((char*)buf1);
    if (alloc2 == SWIG_NEWOBJ) free((char*)buf2);
...
static swig_type_info _swigt__p_p_plist = {"_p_p_plist", "plist **|struct plist **", 0, 0, (void*)0, 0};
...
{"RNAc::get_monomer_mfes", _wrap_get_monomer_mfes},
{"RNAc::pf_fold", _wrap_pf_fold},
{"RNAc::pf_fold_pb", _wrap_pf_fold_pb},
...
{"RNAc::get_intput_line", _wrap_get_intput_line},
...
{"RNAc::str_RNA2RNA", _wrap_str_RNA2RNA},
...
{"RNAc::PS_dot_plot_list_epsilon", _wrap_PS_dot_plot_list_epsilon},
...
XS(SWIG_init) {
  ...
  /*@SWIG:/usr/share/swig1.3/perl5/perltypemaps.swg,64,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "VRNA_INPUT_STRUCTURE", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_From_unsigned_SS_int  SWIG_PERL_CALL_ARGS_1((unsigned int)(32U)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:/usr/share/swig1.3/perl5/perltypemaps.swg,64,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "VRNA_INPUT_NOPRINT_COMMENTS", TRUE | 0x2 | GV_ADDMULTI);
  ...
  /*@SWIG:/usr/share/swig1.3/perl5/perltypemaps.swg,64,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "VRNA_INPUT_NOELIM_WS_SUFFIX", TRUE | 0x2 | GV_ADDMULTI);
